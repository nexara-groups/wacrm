...
/**
 * One message per request + a 50 s pause between sends, so recipients
 * are messaged one by one with a deliberate gap rather than in bursts.
 */
const SEND_BATCH_SIZE = 1;
const SEND_BATCH_DELAY_MS = 50000;
